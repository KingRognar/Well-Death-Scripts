...
public abstract class Enemy_Scr : MonoBehaviour
{
    ...
    /// <summary>
    /// Task, аналогичный Task'е MakeMove(), за исключением того, что не обновляется позиция на карте игры. Предназначен для передвижения трупа при его скатывании
    /// </summary>
    /// <param name="nextPosition">Позиция, в которой должен оказаться труп</param>
